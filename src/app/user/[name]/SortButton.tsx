  ...
  return (
    <div className="relative flex ml-3 items-center justify-center px-[10px] py-[6.75px] h-10 bg-gray-50 dark:bg-gray-900 rounded-md">
      ...
      {toggleSortModal && (
        <div
          ref={modalRef}
          style={{ bottom: `-${modalTop}px` }}
          className={`z-[101] absolute right-2 px-[10px] py-[10px] rounded-md border border-blue-600 min-w-[400px] md:min-w-0 md:w-[863px] min-h-[120px] md:min-h-[80px] p-5 bg-gray-50 dark:bg-gray-600`}
        >
