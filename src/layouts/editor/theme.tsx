...
const theme: EditorThemeClasses = {
  ...
  list: {
    ...
    ulDepth: ["list-inside list-disc", "list-inside list-[circle]", "list-inside list-[square]"],
    olDepth: ["list-inside !list-[decimal]", "list-inside !list-[upper-alpha]", "list-inside !list-[lower-alpha]", "list-inside !list-[upper-roman]", "list-inside !list-[lower-roman]", ],
    ul: 'LexicalTheme__ul',
  },
