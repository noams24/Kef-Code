...
const ChapterCard: React.FC<ChapterCardProps> = ({ title, link, course, complete, index, numberOfQuestions }) => {
  return (
    <div className="hover:chapter-card-container-hover hover:dark:chapter-card-container-hover-dark border dark:bg-slate-800 dark:border-gray-500 border-gray-300 bg-white p-4 w-96 h-24 cursor-pointer flex justify-end">
