...
const SolutionCard: React.FC<SolutionCardProps> = ({ author, date, likes, comments }) => {
    ...
    return (
        <div className="first-letter:bg-gray-200 dark:bg-gray-900 hover:bg-gray-300 dark:hover:bg-gray-800 dark:text-white hover:cursor-pointer rounded-lg shadow p-4 h-20 my-4 no-underline">
